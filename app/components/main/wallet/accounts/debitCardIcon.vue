...
<template>
  ...
  >
    <g>
      <rect x="2" y="20" fill="var(--icon-card-mid)" width="60" height="8" />
      <g>
        <path
          fill="var(--icon-card-soft)"
      ...
      <path
		...
		z M46,40h6v4h-6V40z"
      />
      <rect x="46" y="40" fill="var(--icon-card-chip)" width="6" height="4" />
    </g>
  </svg>
</template>
